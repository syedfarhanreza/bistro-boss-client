...
const Featured = () => {
    return (
        <div className="featured-item hero-overlay bg-opacity-80 bg-fixed text-white pt-12 my-20">
            <SectionTitle
            ...
            <div className="  md:flex justify-center items-center pt-12 pb-20 px-36">
                ...
                <div className="md:ml-10">
                    ...
                    <button className="btn btn-outline border-b-4 border-[#D99904] mt-4">Order Now</button>
                </div>
            </div>
        </div>
    );
